   ...
   <header class="d-flex align-items-center bg-zul">
        <img class="logo p-2" src="./assets/logo.png" alt="logo de la aplicación fluxe">
            <ul class="list-inline d-flex mt-5">
                ...
                <li><a href="RegistrarMovimientoController?ruta=ingreso" class="enlace list-inline-item m-2 fs-3">Incomes</a></li>
            </ul>
            ...
            <form method="POST" action="RegistrarMovimientoController?ruta=guardarEgreso">
                <fieldset>
                    <div class="start-0 top-50 ms-2">
                        ...
                        <input type="text" name="concepto" class="border rounded w-50 mt-3 mb-4 p-2 ms-1" placeholder="p.ej. Transporte, helado, hamburguesa" required>
                    </div>
