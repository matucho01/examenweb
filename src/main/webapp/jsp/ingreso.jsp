                ...
                <fieldset>
                    ...
                    <div class="d-flex flex-column align-items-center">
                        <div class="d-flex justify-content-center mt-2 mb-5">
                            <label class="enlace fw-bold ms-2">Income account</label>
                            <select name="cuentaingreso" class="border rounded mt-2 me-3">
                            ...
                            <select  name="cuentaingresoegreso" class="border rounded mt-2" >
